...
INSERT INTO command_camera (id_type_camera,id_connections_by_workstation,command_user,command_setstring,command_setevent,command_getvalue_test,command_getvalue_real,
...
VALUES 	(2,31,'admin','SSMath_1.B4','SE8','GVMath_1.C4','GVMath_1.B4','','','','','',''),
		(2,32,'admin','SSMath_1.B6','SE8','GVMath_1.D5','GVMath_1.D4','','','','','',''),
		(1,33,'admin','SSInput','SE8','GVCarnada','GVOutput','','','','','','');
